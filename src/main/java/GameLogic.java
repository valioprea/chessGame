...
public class GameLogic {
    ...
    public void testMe(VisualSquare[][] allVisualSquares){
        System.out.println("From game logic -> I was tested");

//        for (int i = 1; i <= 8 ; i++) {
//            for (int j = 1; j <= 8; j++) {
//                System.out.println(allVisualSquares[i][j]);
//            }
//
//        }
    ...
    public void generateSquares(){
        for( int i=1; i<=8; i++){
            for ( int j=1; j<=8; j++) {
                this.allSquares[i][j] = new Square();
    ...
    public ArrayList<InfoTransfer> transferInformation(){
        ArrayList<InfoTransfer> allInfo = new ArrayList<>();

        for (int i = 1; i<=8; i++) {
            for (int j =1; j<=8; j++) {

                if(this.allSquares[i][j].getPiece() != null) {
                    allInfo.add(new InfoTransfer(
                            this.allSquares[i][j].getPiece().getName(),
                            this.allSquares[i][j].getPiece().getColor(),
                            this.allSquares[i][j].getPiece().getPiecePosition()
                    ));
                }
            }
        }
    ...
    public void initializePieces() {
        //WHITE PIECES
        this.allSquares[8][1].setPiece(new Rook("rook", new Position(8,1), "white", true));
        this.allSquares[8][8].setPiece(new Rook("rook", new Position(8,8), "white", true));
        this.allSquares[8][2].setPiece(new Knight("knight", new Position(8,2), "white",true));
        this.allSquares[8][7].setPiece(new Knight("knight", new Position(8,7),"white",true));
        this.allSquares[8][3].setPiece(new Bishop("bishop", new Position(8,3),"white",true));
        this.allSquares[8][6].setPiece(new Bishop("bishop", new Position(8,6), "white",true));
        this.allSquares[8][4].setPiece(new Queen("queen", new Position(8,4), "white", true));
        this.allSquares[8][5].setPiece(new King("king", new Position(8,5),"white", true));

        //BLACK PIECES
        this.allSquares[1][8].setPiece(new Rook("rook", new Position(1,8), "black", false));
        this.allSquares[1][1].setPiece(new Rook("rook", new Position(1,1), "black", false));
        this.allSquares[1][2].setPiece(new Knight("knight", new Position(1,2),"black", false));
        this.allSquares[1][7].setPiece(new Knight("knight", new Position(1,7),"black", false));
        this.allSquares[1][3].setPiece(new Bishop("bishop", new Position(1,3),"black", false));
        this.allSquares[1][6].setPiece(new Bishop("bishop", new Position(1,6), "black", false));
        this.allSquares[1][4].setPiece(new Queen("queen", new Position(1,4), "black",false));
        this.allSquares[1][5].setPiece(new King("king", new Position(1,5), "black", false));
